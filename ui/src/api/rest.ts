 ...
 */
export async function fetchRest (input: RequestInfo, init?: RequestInit | undefined, expectedStatuses: number[] = [200, 201, 202, 203, 204, 205, 206]): Promise<Response> {
    try {
        ...
        throw new Error(`Oops, something went wrong. Please try again later. (${e})`)
    }
}