                    ...
                    <Route exact path={`${path}/profile/create`}>
                        <Row>
                            ...
                            <Col
                                ...
                                sm={24}
                                xs={24}
                                style={{ padding: '0.5rem', backgroundColor: 'rgba(255,255,255,0.8)' }}
                            >
                                <AuthContext.Consumer>
                                    {(auth) =>
                                        auth.isLoggedIn() ? (
                                            <CreateProfileForm uuid={auth.claims.sub} type={auth.account.type} />
                                        ) : (
                                            <></>
                                        )
                                    }
                        ...
                        <Row>
                            ...
                            >
                                <AuthContext.Consumer>
                                    {(auth) =>
                                        auth.isLoggedIn() ? (
                                            <AccountProfile uuid={auth.claims.sub} type={auth.account.type} />
                                        ) : (
                                            <></>
                                        )
                                    }
                    ...
                    <Route exact path={`${path}/billing`}>
                        <Row>
                            <Col
                                ...
                                sm={10}
                                xs={24}
                                style={{ padding: '1rem', backgroundColor: 'rgba(255,255,255,0.8)' }}
                            >
                                Billing
                            </Col>
                        </Row>
